local Webhook_URL = "https://discord.com/api/webhooks/1261005534778359822/3xzeYY7-H3fjj3g6FyP7caH922M61z7o73rcZl7OBA5KbjKEMkVHT5HeDmXNaNdN5Qyq"
...
local data = {
    ["embeds"] = {
        {
            ["title"] = "<a:3160botdiscord:1259040301914259556> WEBHOOK : V2",
            ["description"] = "**Executed Your Script in**",
            ["type"] = "rich",
            ["color"] = tonumber(0x7269da),
            ["fields"] = {
                {
                    ["name"] = "<a:UtilityDeveloper:1241906023338348618> Game Name: ",
...
_G.YouTube = "https://www.youtube.com/@nhatminhzl"
_G.FaceBook = "https://www.facebook.com/nhatminhvnz"
-- phá nát source l hicu
notis = require(game.ReplicatedStorage:WaitForChild("Notification"))
notis.new("<Color=Yellow>By Nhật Minh\n<Color=/>".. _G.ThongBao):Display()
_G.SafeFarm = true
...
ttittles.Text = "WORLD HUB = [ Blox Fruit ]"
...
local Logo = Instance.new("ImageLabel")
	...
	Logo.Image = "rbxassetid://17747757759"]]--
...
ImageButton.Image = "rbxassetid://17747757759"
...
-- UIStroke.Archivable = true
			...
			UICorner_2.Parent = Button
				...
				imgLabelIcon.Image = "rbxassetid://17747757759" 
...
if game.PlaceId == 2753915549 then
    ...
    Notification.Notify("Notification", "Game Not Support :( | Only Blox Fruits.", "rbxassetid://17747757759", {
    Duration = 10,       
    Main = {
        Rounding = true,
    }
...
--------------------------------------------------------------------------------------------------------
local Library = Update:Window("World Hub","BLOX FRUIT",Enum.KeyCode.RightControl);
--------------------------------------------------------------------------------------------------------
...
local Creator = TienTiny:AddLabel('Hii '..game.Players.LocalPlayer.Name.." To World Hub !! Thanks Using.")
...
TienTiny:AddButton('FaceBook Official', function()
...
for i, v in pairs(game:GetObjects("rbxassetid://17468022170")[1]:GetChildren()) do
...
ImageButton1.Image = "http://www.roblox.com/asset/?id=17747757759"
...
----------------------------------------------------------------------------------------------------------------------------------------
Notification.Notify("Notification", "Buy UgPhone Tại Facebook :>", "rbxassetid://17748601157", {
    Duration = 20,       
    Main = {
        Rounding = true,
    }
...
wait(6)
Notification.Notify("Notification", "https://xemnote.com/uunsdOG3r8", "rbxassetid://18383273127", {
    Duration = 10,       
    Main = {
        Rounding = true,
    }
